...
replace(filename,">\d+\w*[</\w+>]*</a>","></\w+></a>", "temp.html")
				...
				if surf_column[i][2] == 'top':
					for j in range(len(data) - head_row_num):
						...
						if noprint == 0:
							...
							if MOF_column == 1:
								Total_DATA.append([data[j+head_row_num][0][0],surf_column[i][1],data[j+head_row_num][surf_column[i][0]][0],'m2/g'])
								print (data[j+head_row_num][0][0],"|",surf_column[i][1],"|",data[j+head_row_num][surf_column[i][0]][0],"|",'m2/g')
								...
								Total_DATA.append([MOF_name, surf_column[i][1],data[j+head_row_num][surf_column[i][0]][0],'m2/g'])
								print (MOF_name,"|", surf_column[i][1],"|",data[j+head_row_num][surf_column[i][0]][0],"|",'m2/g')
							elif MOF_data_in_MOFcol == 1:
								Total_DATA.append([MOF_name, surf_column[i][1],data[j+head_row_num][surf_column[i][0]][0],'m2/g'])
								print (MOF_name,"|", surf_column[i][1],"|",data[j+head_row_num][surf_column[i][0]][0],"|",'m2/g')							
							else:
								Total_DATA.append(['*NO_MOF_data*', surf_column[i][1],data[j+head_row_num][surf_column[i][0]][0],'m2/g'])
					...
					for j in range(len(data[i]) - 1):
						...
						if noprint == 0:
							if MOF_column == 1:
								...
								Total_DATA.append([MOF_name, surf_column[i][1], data[surf_column[i][0]][j+1][0], 'm2/g'])
								...
								Total_DATA.append(['*NO_MOF_data*', surf_column[i][1], data[surf_column[i][0]][j+1][0], 'm2/g'])
...
range_prob = re.compile('\s?range\s?[-]?\s?of\s\d+\s?\W?\s?\d+|\s?excess\s?of\s?\d+|from\s?\d+\s?to\s?\d+\s?|from\s?\d+|over\s?\d+|\d+\s?~\s?\d+|\d+\s?–\s?\d+|as\s?high\s?as\s?\d+|∼\d+|[<>]\d+|\s?exceeding\s?\d+', re.I)
